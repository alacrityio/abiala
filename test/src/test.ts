...
function check_types() {
  ...
  check_type(
    ...
    js2Types,
    "public_key",
    '"PUB_R1_1111111111111111111111111111111116amPNj"'
  );
  check_type(
    0,
    js2Types,
    "public_key",
    '"PUB_R1_67vQGPDMCR4gbqYV3hkfNz3BfzRmmSj27kFDKrwDbaZKtaX36u"'
  );
  check_type(
    0,
    js2Types,
  ...
  check_type(
    ...
    js2Types,
    "public_key",
    '"PUB_R1_7zetsBPJwGQqgmhVjviZUfoBMktHinmTqtLczbQqrBjhaBgi6x"'
  );
  check_type(
    0,
    js2Types,
  ...
  check_type(
    ...
    js2Types,
    "signature",
    '"SIG_WA_"'
  );
  check_type(
    0,
    js2Types,
  ...
  check_type(
    ...
    js2Types,
    "extended_asset",
    '{"quantity":"0 FOO","contract":"bar"}'
  );
  check_type(
    0,
    js2Types,
    "extended_asset",
    '{"quantity":"0.123456 SIX","contract":"seven"}'
  );
