...
ALAIO_REFLECT(webauthn_public_key, key, user_presence, rpid);
ALAIO_COMPARE(webauthn_public_key);
...
ALAIO_REFLECT(webauthn_signature, compact_signature, auth_data, client_json);
ALAIO_COMPARE(webauthn_signature);
