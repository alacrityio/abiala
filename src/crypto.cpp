...
std::string alaio::public_key_to_string(const public_key& key) {
...
std::string alaio::private_key_to_string(const private_key& private_key) {
...
private_key alaio::private_key_from_string(std::string_view s) {
...
std::string alaio::signature_to_string(const alaio::signature& signature) {
...
signature alaio::signature_from_string(std::string_view s) {
